 ...
 */
public class TypeCancelDataIssueResponseImpl extends ch.crif_online.www.webservices.crifsoapservice.v1_00.impl.TypeBaseResponseImpl implements ch.crif_online.www.webservices.crifsoapservice.v1_00.TypeCancelDataIssueResponse
{
    private static final long serialVersionUID = 1L;
    
    public TypeCancelDataIssueResponseImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ADDITIONALOUTPUT$0 = 
    ...
    public ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair[] getAdditionalOutputArray()
    {
        synchronized (monitor())
        {
            ...
            get_store().find_all_element_users(ADDITIONALOUTPUT$0, targetList);
    ...
    public ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair getAdditionalOutputArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair)get_store().find_element_user(ADDITIONALOUTPUT$0, i);
            if (target == null)
            {
    ...
    public int sizeOfAdditionalOutputArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ADDITIONALOUTPUT$0);
        }
    }
    ...
    {
        check_orphaned();
        arraySetterHelper(additionalOutputArray, ADDITIONALOUTPUT$0);
    }
    ...
    public ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair insertNewAdditionalOutput(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair target = null;
            target = (ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair)get_store().insert_element_user(ADDITIONALOUTPUT$0, i);
            return target;
        }
    }
    ...
    public ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair addNewAdditionalOutput()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair target = null;
            target = (ch.crif_online.www.webservices.crifsoapservice.v1_00.KeyValuePair)get_store().add_element_user(ADDITIONALOUTPUT$0);
            return target;
        }
    }
    ...
    public void removeAdditionalOutput(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ADDITIONALOUTPUT$0, i);
        }
    }
}
